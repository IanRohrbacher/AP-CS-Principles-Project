...
while restart:
    ...
    def rolling_animation():
        ...
        for i in range(5):
            dice(i, DICE_RED)
            if ROUND == 13:
                FONT.render_to(SCREEN, number_positions[i], "2", BLACK)
                dice_number = [2, 2, 2, 2, 2]

            elif ROUND == 12:
                if i == 0:
                    sudo_random_number = 1
                elif i == 1:
                    sudo_random_number = 4
                elif i == 2:
                    sudo_random_number = 4
                elif i == 3:
                    sudo_random_number = 3
                elif i == 4:
                    sudo_random_number = 4
                FONT.render_to(SCREEN, number_positions[i], str(sudo_random_number), BLACK)
                dice_number = [1, 4, 4, 3, 4]

            elif ROUND == 11:
                if i == 0:
                    sudo_random_number = 2
                elif i == 1:
                    sudo_random_number = 6
                elif i == 2:
                    sudo_random_number = 6
                elif i == 3:
                    sudo_random_number = 2
                ...
                if i == 0:
                    ...
                    sudo_random_number = 5
                elif i == 3:
                    sudo_random_number = 3
                elif i == 4:
                    sudo_random_number = 2
                FONT.render_to(SCREEN, number_positions[i], str(sudo_random_number), BLACK)
                dice_number = [4, 6, 5, 3, 2]
                ...
                if i == 0:
                    ...
                    sudo_random_number = 1
                FONT.render_to(SCREEN, number_positions[i], str(sudo_random_number), BLACK)
                dice_number = [6, 6, 6, 6, 1]

            elif ROUND == 7:
                FONT.render_to(SCREEN, number_positions[i], "6", BLACK)
                dice_number = [6, 6, 6, 6, 6]
                ...
                if i == 0:
                    ...
                    sudo_random_number = 5
                FONT.render_to(SCREEN, number_positions[i], str(sudo_random_number), BLACK)
                dice_number = [5, 3, 5, 5, 5]

            elif ROUND == 3 or ROUND == 2:
                FONT.render_to(SCREEN, number_positions[i], "2", BLACK)
                dice_number = [2, 2, 2, 2, 2]
    ...
    def end_screen():
        global SCREEN_WIDTH, SCREEN_HEIGHT, locked_scoreboard_numbers, left_total, right_total, yahtzee_total, bonus_flip, bonus_total, final_total
        bonus()
        render_score()
        ...
        SMALL_FONT.render_to(SCREEN, ((SCREEN_WIDTH / 6), SCREEN_HEIGHT / 5),
                             "Left Total: " + str(left_total), (255, 255, 255))
        SMALL_FONT.render_to(SCREEN, ((SCREEN_WIDTH / 6), (SCREEN_HEIGHT / 5) + 75),
                             "Right Total: " + str(right_total), (255, 255, 255))
        SMALL_FONT.render_to(SCREEN, ((SCREEN_WIDTH / 6), (SCREEN_HEIGHT / 5) + 150),
                             "Bonus: " + str(bonus_total), (255, 255, 255))
        SMALL_FONT.render_to(SCREEN, ((SCREEN_WIDTH / 6), (SCREEN_HEIGHT / 5) + 225),
                             "Yahtzees: " + str(yahtzee_total), (255, 255, 255))
        SMALL_FONT.render_to(SCREEN, ((SCREEN_WIDTH / 6), (SCREEN_HEIGHT / 5) + 300),
